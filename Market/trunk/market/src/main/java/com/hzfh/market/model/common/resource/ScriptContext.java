...
public class ScriptContext {
    ...
    private static String buildEnvironmentVariable() {
        ...
        sb.append(String.format("%1$s:'%2$s',", "WWWSite", WebInfoHelper.WEB_MARKET_WWW));
        sb.append(String.format("%1$s:'%2$s',", "ImgSite", WebInfoHelper.WEB_MARKET_RESOURCE_IMG));

        sb.append(String.format("%1$s:'%2$s',", "LocalFileSite", WebInfoHelper.WEB_MARKET_UPLOAD));
