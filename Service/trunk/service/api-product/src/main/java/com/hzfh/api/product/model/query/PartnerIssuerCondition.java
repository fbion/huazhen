...
public class PartnerIssuerCondition extends QueryCondition implements Serializable {
	private String name;
	private int partnerIssuertype;
	...
	public int getPartnerIssuertype() {
		return partnerIssuertype;
	}
	public void setPartnerIssuertype(int partnerIssuertype) {
		this.partnerIssuertype = partnerIssuertype;
	}
