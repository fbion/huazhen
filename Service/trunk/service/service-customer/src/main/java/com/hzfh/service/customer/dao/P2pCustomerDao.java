...
public interface P2pCustomerDao extends BaseDao<P2pCustomer, P2pCustomerCondition> {
    ...
    public int updateP2pCustomerById(int id,int custoemrNo);

	public int updateNotWithCardNumber(P2pCustomer p2pCustomer);
	public int updateWithCardNumber(P2pCustomer p2pCustomer);

    public P2pCustomer getP2pCustomerByCustomerNo(int customerNo);
