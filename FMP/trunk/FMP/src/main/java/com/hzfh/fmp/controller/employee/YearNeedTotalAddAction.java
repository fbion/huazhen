...
import com.hzfh.fmp.model.employee.YearNeedModel;
...
public class YearNeedTotalAddAction extends CommonAction {
    ...
    public String execute() throws Exception {
        this.setPageAlias(PageAlias.yearNeedTotalAdd);
        ...
        this.year = YearNeedTotalModel.getInfo(this.id).getFinancialYear();
    ...
    private void initShowEditButton() {
    	...
    	YearNeedTotal tApplication = new YearNeedTotal();
    	tApplication=YearNeedTotalModel.getInfo(this.id);
