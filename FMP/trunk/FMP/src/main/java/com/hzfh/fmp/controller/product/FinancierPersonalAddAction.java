...
public class FinancierPersonalAddAction extends CommonAction {
    ...
    public String execute() throws Exception {
        this.setPageAlias(PageAlias.financierPersonalAdd);
    ...
    public String executeDetail() throws Exception {
        this.setPageAlias(PageAlias.financierPersonalDetail);
        String ret = super.execute();
        if (!ret.equals(SUCCESS))
            return ret;
