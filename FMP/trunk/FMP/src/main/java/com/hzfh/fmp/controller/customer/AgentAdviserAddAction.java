...
public class AgentAdviserAddAction extends CommonAction {
    ...
    public String execute() throws Exception {
        this.setPageAlias(PageAlias.agentAdviserAdd);
    ...
    public String executeDetail() throws Exception {
        this.setPageAlias(PageAlias.agentAdviserDetail);
        String ret = super.execute();
        if (!ret.equals(SUCCESS))
            return ret;
    ...
    private void initPageVar() {
        ...
        sb.append(String.format("%1$s:'%2$s',", "AgentType", DictionaryHelper.DIC_AgentAdviser));
