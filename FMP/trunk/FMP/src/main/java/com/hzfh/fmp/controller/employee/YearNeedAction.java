...
public class YearNeedAction extends CommonAction {
	/*private boolean showAddButton;

    public boolean isShowAddButton() {
        return showAddButton;
    }*/
    private List<YearNeed> FinancialYears;
	public List<YearNeed> getFinancialYears() {
    ...
    public String execute() throws Exception {
        this.setPageAlias(PageAlias.yearNeedList);
		...
		try {
			 this.FinancialYears=YearNeedModel.getFinancialYear();
		} catch (Exception e) {
			e.printStackTrace();
		}
