...
public class ActivitiesAddAction extends CommonAction {
    ...
    public String execute() throws Exception {
        this.setPageAlias(PageAlias.activitiesAdd);
    ...
    public String executeAddDetail() throws Exception {
        this.setPageAlias(PageAlias.activitiesAddDetail);
        String ret = super.execute();
        if (!ret.equals(SUCCESS))
            return ret;
        if (this.getPagePermissionView() != null && this.getPagePermissionView().isCreate())
    ...
    private void initPageVar() {
        ...
        sb.append(String.format("%1$s:'%2$s',", "AID", this.aId));
