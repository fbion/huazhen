...
public class FinancierBusinessAddAction extends CommonAction {
    ...
    public String execute() throws Exception {
        this.setPageAlias(PageAlias.financierBusinessAdd);
    ...
    public String executeDetail() throws Exception {
        this.setPageAlias(PageAlias.financierBusinessDetail);
        String ret = super.execute();
        if (!ret.equals(SUCCESS))
            return ret;
