...
public class AjaxSalesAction extends JqGridBaseAction<Sales> {
    ...
    public String getEnclosureBySalesNo(){
        List<ActivityAttachment> activityAttachmentList =  ActivityAttachmentModel.getListBySalesNo(this.salesNo);
        if(activityAttachmentList.size()>0){
            this.path = activityAttachmentList.get(0).getPath();
        }
        return SUCCESS;
    }
