...
public class DeptYearNeedDetailAction extends CommonAction {
	...
	/*private List<DeptYearNeed> FinancialYears;
	public List<DeptYearNeed> getFinancialYears() {
		return FinancialYears;
	}*/
    @Override
    public String execute() throws Exception {
        this.setPageAlias(PageAlias.deptYearNeedDetailList);
		...
		if (this.getPagePermissionView() != null && this.getPagePermissionView().isCreate()) {
		 ...
		 //this.FinancialYears=DeptYearNeedModel.getFinancialYear();
		 initPageVar();
        return SUCCESS;
    }
