                ...
                <ul class="tab_content">
                    <li class="tab_content1  tabContent" style="display:block;">
                        <div class="basic_Info_content p15 info_All">
                            <form id="auditTaskAdd" style="z-index:9999;">
                                <ul>
                                    <li>
										<span>requestUser</span> 
										<input id="requestUser" name="requestUser" type="text" disabled="disabled" class="ml20 data"/>
                                        <div class="Validform_checktip"></div>
                                    </li>
<li>
										<span>requestDate</span> 
										<input id="requestDate" name="requestDate" type="text" disabled="disabled" class="ml20 data"/>
                                        <div class="Validform_checktip"></div>
                                    </li>
...
<ul>
                                    <li>
										<span>taskNo</span> 
										<input id="taskNo" name="taskNo" type="text" disabled="disabled" class="ml20 data"/>
                                        <div class="Validform_checktip"></div>
                                    </li>
<li>
										<span>proInNo</span> 
										<input id="proInNo" name="proInNo" type="text" disabled="disabled" class="ml20 data"/>
                                        <div class="Validform_checktip"></div>
                                    </li>
