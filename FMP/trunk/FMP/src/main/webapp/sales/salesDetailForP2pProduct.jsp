                            ...
                            <form id="salesAdd" style="z-index:9999;">
                                ...
                                <p id="btn" class="mt50">
                                    ...
                                    <s:if test="showBuildButton">
                                        ...
                                        <input id="cancelSales" name="cancelSales" type="submit" value="取消订单" class="submit_Btn  btn_style"/>
                                    ...
                                    <div>
                                        ...
                                        <div data-options="region:'south',border:false"
                                            ...
                                            <input id="submit2" name="" type="submit" value="驳回"
                                                   class="submit_Btn  btn_style examine"/>
                                            <input id="cancelSales" name="cancelSales" type="submit" value="取消订单"
                                                   class="submit_Btn  btn_style"/>
                                        </div>
                                    </div>
                                </div>
