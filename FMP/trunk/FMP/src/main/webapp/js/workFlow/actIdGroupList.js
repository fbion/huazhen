var ManagePage = {
    ...
    InitGrid: function () {
        //grid start
        $("#gridTable").jqGrid({
            url: $Url.BuildWorkFlowUrl('/workFlow/actIdGroup/ajaxListActIdGroup.action'),
            editurl: $Url.BuildWorkFlowUrl("/workFlow/actIdGroup/ajaxEditActIdGroup.action"),
            datatype: "json",
            mtype: 'GET',
            colNames: ["操作","iD","名称","类型"],
            colModel: [
				{
				...
				{
					name: "type", index: "type", width: 40, align: "left", formoptions: { rowpos: 3, colpos: 1 }, sortable: false, editable: true, editoptions: { size: 40 }
				}                
            ],
            sortname: "id",
            sortorder: "desc",
    ...
    GetDetail: function (index) {
        window.location.href = $Url.BuildWorkFlowUrl("/workFlow/aCTIDGROUP/edit?id="+index);
    ...
    //},
    GetAdd: function () {
        window.location.href = $Url.BuildWorkFlowUrl("/workFlow/actIdGroup/edit")
