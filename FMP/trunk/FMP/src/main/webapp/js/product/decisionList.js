var ManagePage = {
    ...
    InitGrid: function () {
        //grid start
        $("#gridTable").jqGrid({
            url: $Url.BuildProductUrl('/product/decision/ajaxListDecision.action'),
            editurl: $Url.BuildProductUrl("/product/decision/ajaxEditDecision.action"),
            datatype: "json",
            mtype: 'GET',
            colNames: ["操作","编号","产品","审核部门","是否通过","审核时间","审核人","顺序","备注"],
            colModel: [
				...
				{
					name: "productNo", index: "productNo", width: 40, align: "left", formoptions: { rowpos: 2, colpos: 1 }, sortable: false, editable: true, editoptions: { size: 40 }
				},
				{
