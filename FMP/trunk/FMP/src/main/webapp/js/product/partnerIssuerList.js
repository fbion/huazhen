var ManagePage = {
    ...
    GetAdd:function(){
        window.open($Url.BuildProductUrl("/product/partnerIssuer/edit"));
    },
    GetDetail:function(id){
        window.open($Url.BuildProductUrl("/product/partnerIssuer/edit?id="+id));
    },
    GetEdit:function(id){
        window.open($Url.BuildProductUrl("/product/partnerIssuer/detail?id="+id));
    },
    ShowPoint:function(){
