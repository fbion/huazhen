var ManagePage = {
    ...
    InitGrid: function () {
        //grid start
        $("#gridTable").jqGrid({
            url: $Url.BuildSalesUrl('/sales/salesEmpCalculate/ajaxListSalesEmpCalculate.action'),
            editurl: $Url.BuildSalesUrl("/sales/salesEmpCalculate/ajaxEditSalesEmpCalculate.action"),
            datatype: "json",
            mtype: 'GET',
            colNames: ["操作","id","salesCode","dealTime","moneySale","moneyContribute","calcTime"],
            colModel: [
				...
				{
					name: "salesCode", index: "salesCode", width: 40, align: "left", formoptions: { rowpos: 2, colpos: 1 }, sortable: false, editable: true, editoptions: { size: 40 }
				},
				{
					name: "dealTime", index: "dealTime", width: 40, align: "left", formoptions: { rowpos: 2, colpos: 2 }, sortable: false, formatoptions: { srcformat: 'Y-m-d H:i:s', newformat: 'Y-m-d H:i:s' }, editable: true, edittype: 'custom', editoptions: { custom_element: ManagePage.DateInputElem, custom_value: ManagePage.DateInputValue, size: 40 }
				},
				{
					name: "moneySale", index: "moneySale", width: 40, align: "left", formoptions: { rowpos: 3, colpos: 1 }, sortable: false, editable: true, editoptions: { size: 40 }
				},
				{
					name: "moneyContribute", index: "moneyContribute", width: 40, align: "left", formoptions: { rowpos: 3, colpos: 2 }, sortable: false, editable: true, editoptions: { size: 40 }
				},
				{
