...
//                },
    ...
    GetDetail: function (index) {
        window.open($Url.BuildEmployeeUrl("/employee/knowledgeBase/edit?id="+index));

    },
    GetEdit: function (index) {
        window.open($Url.BuildEmployeeUrl("/employee/knowledgeBase/info?id="+index));

    },
    GetAdd: function () {
        window.open($Url.BuildEmployeeUrl("/employee/knowledgeBase/edit"));
