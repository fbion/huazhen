var ManagePage = {
    ...
    GetDetail: function (index) {
        window.open($Url.BuildEmployeeUrl("/employee/suppliers/detail?id="+index));
    ...
    GetEdit: function (index) {
    	window.open($Url.BuildEmployeeUrl("/employee/suppliers/edit?id="+index));
    //    jQuery("#gridTable").jqGrid('editGridRow', index, {
    ...
    GetAdd: function () {
        window.open($Url.BuildEmployeeUrl("/employee/suppliers/edit"));
