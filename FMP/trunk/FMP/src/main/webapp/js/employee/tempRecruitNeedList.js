...
//    	var backUrl = window.location.href;
        window.open($Url.BuildEmployeeUrl("/employee/tempRecruitNeed/edit?id="+index+"&activitiNo="+activitiNo));
       
    },
   
    GetAdd: function () {
//    	var backUrl = window.location.href;
        window.open($Url.BuildEmployeeUrl("/employee/tempRecruitNeed/edit"));
