var ManagePage = {
    ...
    GetDetail: function (index,activitiNo) {
        window.open($Url.BuildEmployeeUrl("/employee/probationWorkSummary/edit?id="+index+"&activitiNo="+activitiNo));

    },

    GetAdd: function () {
        window.open($Url.BuildEmployeeUrl("/employee/probationWorkSummary/edit"));
