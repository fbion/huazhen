...
//    	var backUrl = window.location.href;
        window.open($Url.BuildEmployeeUrl("/employee/managerEvaluation/edit?id="+index+"&activitiNo="+activitiNo));
    },
    GetAdd: function () {
//    	var backUrl = window.location.href;
        window.open($Url.BuildEmployeeUrl("/employee/managerEvaluation/edit"));
    }/*,
    FmatterActiviti:function(cellvalue, options, rowObject){
    	if(cellvalue==0){
    		return "待审核";
    	}else if(cellvalue==1){
    		return "已审核";
