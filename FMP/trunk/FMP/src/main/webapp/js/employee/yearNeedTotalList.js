var ManagePage = {
    ...
    GetDetail: function (index,activitiNo) {
        window.open($Url.BuildEmployeeUrl("/employee/yearNeedTotal/edit?id="+index+"&activitiNo="+activitiNo));
    },
    GetAdd: function () {
        window.open($Url.BuildEmployeeUrl("/employee/yearNeedTotal/edit"));
    }
}
$(function () {
