var LetterPageManage = {
		getAgentBusinessPage:function(){
			var url = $Url.BuildLoginUrl('/sendLetterForAgentBusiness');
	        $.ajax({
	                type: "POST",
	                url: url,
	                async:false,  
		...
		bindProduct:function(){
			$.fn.linkage({
		        ...
		        actionUrl: $Url.BuildLoginUrl("/common/enumList.action"),
		        all: false
		    });
		},
		...
		setAgentBusinessLetterInfo:function(){
			...
			var url = $Url.BuildLoginUrl('/sendLetterGo');
	        $.ajax({
	                type: "POST",
	                url: url,
	                async:false,  
	                ...
	                success: function (data) {
	                   alert(data.msg);
	                  window.location.href = $Url.BuildLoginUrl("/customer/agentBusiness/list");
	                }
	            }
	        );
