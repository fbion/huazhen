...
$.fn.EmployeeTree = function (options) {
    ...
    $.showBox = function (opt, obj) {
        ...
        function content() {
            ...
            var url = $Url.BuildLoginUrl("/makeTree?id=" + 1);
            tree.loadXML(url);
...
function showMenu() {
    ...
    $("#menuContent").css({left:employeeOffset.left-130 + "px", top:employeeOffset.top + employeeObj.outerHeight()-70 + "px"}).slideDown("fast");
