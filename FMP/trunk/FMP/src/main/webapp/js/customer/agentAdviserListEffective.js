var ManagePage = {
    ...
    GetDetail:function(id){
        window.open($Url.BuildCustomerUrl("/customer/agentAdviser/edit?id="+id));
    },
    GetEdit:function(id){
        window.open($Url.BuildCustomerUrl("/customer/agentAdviser/detail?id="+id));
    },
    GetAdd:function () {
        window.open($Url.BuildCustomerUrl("/customer/agentAdviser/edit"));
    },
    ShowPoint:function(){
