var ManagePage = {
    ...
    pic2Click:function(id){
    	$("#icon2"+id).click(function () {
    		window.open($Url.BuildCustomerUrl("/customer/activities/addDetail?id=" + id));
    	});
    },
...
//                }        	
    ...
    $("#addCondition").click(function () {
    	if (Number(PageVar.ID) == 0 || $("#submit").css("display")=="inline") {
        	...
        	window.open($Url.BuildCustomerUrl("/customer/activities/addDetail?aId=" + Number(PageVar.ID)));
