var ManagePage = {
    ...
    InitGrid: function () {
        ...
        $("#gridTable").jqGrid({
            ...
            colModel: [
                ...
                {
                    name: "name", index: "name", width: 40, align: "left",formatter: $Link.MakeCustomerPersonalUrl, formoptions: { rowpos: 3, colpos: 1 }, sortable: false, editable: true, editoptions: { size: 20 }, editrules: { required: true }
                },
                {
    ...
    InitQuery: function () {
        $("#btnSearch").click(function () {
            ...
            var byIsSales = $("#selectIsSales").val();
            ...
            $("#gridTableFollow").jqGrid(
                {
                    ...
                    mtype : 'GET', // "推荐产品类型",
                    colNames : ["编号","推荐产品", "跟踪类型", "跟踪时间", "下次跟踪时间", "跟踪内容", "跟踪结果描述" ],//, "备注"
                    colModel : [
                        {
