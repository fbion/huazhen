var ManagePage = {
    ...
    GetDetail: function (index) {
        window.open($Url.BuildCustomerUrl("/customer/customerCompany/detail?id="+index));
    },
    GetEditAdd:function (id) {
        window.open($Url.BuildCustomerUrl("/customer/customerCompany/edit?id=")+id);
    },
    GetAddAdd:function () {
        window.open($Url.BuildCustomerUrl("/customer/customerCompany/edit"));
    },
