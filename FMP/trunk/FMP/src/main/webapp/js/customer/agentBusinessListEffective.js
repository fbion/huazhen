...
//            multiselect: true,
    ...
    GetDetails: function (id) {
        window.open($Url.BuildCustomerUrl("/customer/agentBusiness/detail?id=" + id));
    },
    GetEdit: function (id) {
        window.open($Url.BuildCustomerUrl("/customer/agentBusiness/edit?id=" + id));
    },
    GetAdd: function () {
        window.open($Url.BuildCustomerUrl("/customer/agentBusiness/edit"));
    },
    ShowPoint:function(){
