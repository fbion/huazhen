                ...
                <ul class="tab_content">
                    <li class="tab_content1  tabContent" style="display:block;">
                        <div class="basic_Info_content p15 info_All">
                            <form id="winningRecordAdd" style="z-index:9999;">
                                <ul>
                                    <li>
										<span>userId</span> 
										<input id="userId" name="userId" type="text" disabled="disabled" class="ml20 data"/>
...
<ul>
                                    <li>
										<span>isAward</span> 
										<input id="isAward" name="isAward" type="text" disabled="disabled" class="ml20 data"/>
                                        <div class="Validform_checktip"></div>
                                    </li>
<li>
										<span>mark</span> 
