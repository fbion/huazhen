...
public class ActivityRuleRelationFacade {
    ...
    public static List<ActivityRuleRelation> getInfoByActivityNo(int id){
        ...
        return activityRuleRelationService.getInfoByActivityNo(id);
    }
    ...
    public static ActivityRuleRelation getInfoByRuleid(int id){
        ...
        return activityRuleRelationService.getInfoByRuleid(id);
    }

	public static int deleteInfoByCondId(int id) {
		ActivityRuleRelationService activityRuleRelationService = (ActivityRuleRelationService) context.getBean("activityRuleRelationService");

        return activityRuleRelationService.deleteInfoByCondId(id);
	}
}
