...
public class SmsModel {
    ...
    public static String smsProductExpire(String time,String productName,String money){
    ...
    public static String smsProductInterest(String time,String productName,String money,String times){
    ...
    public static String smsContinueInvestment(String time,String productName,String money1,String money2){
    ...
    public static String smsContinueInvestmentInterest(String time,String productName,String money){
        Smstemplete smstemplete = templeteCache("smsContinueInvestmentInterest", SmsTempleteType.SMS_CONTINUE_INVESTMENTINTEREST);
        String content = smstemplete.getContent();
        content = content.replace("${PRODUCT_NAME}",productName);
        content = content.replace("${TIME}",time);
        content = content.replace("${MONEY}",money);
