...
public class FixedAssetsAddAction extends CommonAction {
    ...
    public String execute() throws Exception {
        this.setPageAlias(PageAlias.fixedAssetsAdd);
    ...
    public String executeDetail() throws Exception {
        this.setPageAlias(PageAlias.fixedAssetsDetail);
        String ret = super.execute();
        if (!ret.equals(SUCCESS))
            return ret;
    ...
    public String executeAddAll() throws Exception {
        this.setPageAlias(PageAlias.fixedAssetsAddAll);
        String ret = super.execute();
        if (!ret.equals(SUCCESS))
            return ret;
