...
public class PaymentReportDeatilAction extends CommonAction {
	...
	public boolean showExamineSubmitButton;
    
    public boolean isShowExamineSubmitButton() {
        return showExamineSubmitButton;
    }
    ...
    public String execute() throws Exception{
        ...
        if (!StringHelper.isNullOrEmpty(this.activitiNo)) {
                this.showExamineSubmitButton = false;
        } else {
            this.showExamineSubmitButton = true;
        }
        if (!StringHelper.isNullOrEmpty(this.activitiNo)) {
