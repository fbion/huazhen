...
public class P2pProductAddAction extends CommonAction {
    ...
    private boolean showEditAmount;

    public boolean isShowEditAmount() {
        return showEditAmount;
    }

    public void setShowEditAmount(boolean showEditAmount) {
        this.showEditAmount = showEditAmount;
    }
    ...
    private void initShowEditAmount(){
        if (this.getPagePermissionView().getTagPermission(TagPermission.SHOW_EDIT_AMOUNT) == TagPermissionType.query) {
