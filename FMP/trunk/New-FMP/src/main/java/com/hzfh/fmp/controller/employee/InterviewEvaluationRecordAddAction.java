...
public class InterviewEvaluationRecordAddAction extends CommonAction {
    ...
    public String execute() throws Exception {
        this.setPageAlias(PageAlias.interviewEvaluationRecordAdd);
        ...
        /*InterviewEvaluationRecord ie = InterviewEvaluationRecordModel.getInfo(id);
        if(ie!=null){
        	if(ie.getConclusion()!=4){
