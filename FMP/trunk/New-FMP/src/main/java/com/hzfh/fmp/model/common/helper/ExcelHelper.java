...
,"交易状态","是否发送短信",
	...
	public void getExcelForWinningRecordList() {
        List<WinningRecord> winningRecordList = WinningRecordModel.getList();
        ...
        GenerateExcelTemplate<WinningRecord> generateExcelTemplate = new GenerateExcelTemplate<WinningRecord>(winningRecordList);
        XLSCallBack<WinningRecord> xlscaCallBack = new XLSCallBack<WinningRecord>() {
            ...
            @Override
            public String[] getValue(WinningRecord t) throws RuntimeException {
               
                String[] values = {
                		t.getUserName()==null?"":t.getUserName(),
                		t.getName()==null?"":t.getName(),
                	    t.getCellphone()==null?"":t.getCellphone(),	
                	    t.getDrawAwards()==null?"":t.getDrawAwards(),	
                	    t.getIsAwardStr()==null?"":t.getIsAwardStr()		
                };
                return values;
            }
