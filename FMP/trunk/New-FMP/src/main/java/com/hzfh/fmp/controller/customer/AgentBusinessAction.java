...
public class AgentBusinessAction extends CommonAction {

    private boolean showAddButton;
    private String pageVar;
	private boolean showExcelButton;
	private boolean showSendLetterButton;
	
	

	public boolean isShowSendLetterButton() {
		return showSendLetterButton;
	}
    ...
    public String execute() throws Exception {
        this.setPageAlias(PageAlias.agentBusinessList);
        ...
        if (this.getPagePermissionView().getTagPermission(TagPermission.EXCEL_AGENT_BUSINESS) == TagPermissionType.query) {
    ...
    public String executeEffective() throws Exception {
        this.setPageAlias(PageAlias.agentBusinessListEffective);
