...
public class StateValues {
    ...
    public static void setColumnProperty(String pageAlias, String columnCookie) {
        instance.cookieManager.setCookie(ServletActionContext.getResponse(),pageAlias,columnCookie);
    }

    public static String getColumnProperty(String pageAlias) {
        return instance.cookieManager.getCookieValues(ServletActionContext.getRequest(), pageAlias);
    }
}
