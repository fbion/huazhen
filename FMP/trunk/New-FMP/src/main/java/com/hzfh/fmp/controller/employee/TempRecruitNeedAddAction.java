...
public class TempRecruitNeedAddAction extends CommonAction {
    ...
    public boolean isShowAuditButton() {
		return showAuditButton;
	}

	public void setShowAuditButton(boolean showAuditButton) {
		this.showAuditButton = showAuditButton;
	}
	...
	/*  private int  showAuditButton;
    
	public int getShowAuditButton() {
		return showAuditButton;
	}
	public void setShowAuditButton(int showAuditButton) {
		this.showAuditButton = showAuditButton;
	}
*/
    ...
    public String execute() throws Exception {
        this.setPageAlias(PageAlias.tempRecruitNeedAdd);
       ...
       // showAuditButton = AuditTaskModel.getAuditButtonStatus(TempRecruitNeedModel.getInfo(id).getActivitiNo(), UserHelper.getEditUserNo());
	...
	private void initShowEditButton() {
    	...
    	TempRecruitNeed tApplication = new TempRecruitNeed();
    	tApplication=TempRecruitNeedModel.getInfo(this.id);
