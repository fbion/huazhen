...
public class PaymentReportDeatilFacade {
    ...
    public static PaymentReportDeatil getTotalPayMoneyByPaymentReportNo(int paymentReportNo){
        PaymentReportDeatilService paymentReportDeatilService = (PaymentReportDeatilService) context.getBean("paymentReportDeatilService");
        return paymentReportDeatilService.getTotalPayMoneyByPaymentReportNo(paymentReportNo);
    }
