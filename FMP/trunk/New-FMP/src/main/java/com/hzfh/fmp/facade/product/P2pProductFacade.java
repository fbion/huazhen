...
public class P2pProductFacade {
    ...
    public static int addP2pVideo(P2pProduct p2pVideo) {
        P2pProductService p2pProductService = (P2pProductService) context.getBean("p2pProductService");
        return p2pProductService.addP2pVideo(p2pVideo);
    }

    public static List<P2pProduct> getP2pProductByStatus(byte status) {
        P2pProductService p2pProductService = (P2pProductService) context.getBean("p2pProductService");
        return p2pProductService.getP2pProductByStatus(status);
    }
    ...
    public static int updateLogpPathById(int id, String logoPath) {
        P2pProductService p2pProductService = (P2pProductService) context.getBean("p2pProductService");
        return p2pProductService.updateLogpPathById(id, logoPath);
    }
