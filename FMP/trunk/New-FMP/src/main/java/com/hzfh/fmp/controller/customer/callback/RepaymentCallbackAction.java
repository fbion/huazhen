package com.hzfh.fmp.controller.customer.callback;
...
public class RepaymentCallbackAction extends CallBackAction<RepaymentCallback> {
    ...
    private String message = "活动打款操作完成，请等待进一步审核";
    ...
    public String execute() throws Exception {
        this.setPageAlias(PageAlias.activitiesList);
        ...
        paymentRefundUrl = UrlHelper.buildCustomerSiteUrl("/customer/activities/list?navSub=activitiesList");
        return SUCCESS;
    }
}
