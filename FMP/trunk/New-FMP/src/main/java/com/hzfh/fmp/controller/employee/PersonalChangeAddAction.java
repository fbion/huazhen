...
public class PersonalChangeAddAction extends CommonAction {
    ...
    public String execute() throws Exception {
        this.setPageAlias(PageAlias.personalChangeAdd);
    ...
    private void initShowEditButton() {
    	...
    	PersonalChange tApplication = new PersonalChange();
    	tApplication=PersonalChangeModel.getInfo(this.id);
