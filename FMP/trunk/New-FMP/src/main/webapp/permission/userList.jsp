	...
	<m:Content contentPlaceHolderId="center">
		...
		<div class="pic mt20">
			...
			<div id="gridPager" class="gridPager"></div>
				...
				<!-- 角色分配 -->
					<div id="w" class="easyui-window" title="角色分配" data-options="closed:true,iconCls:'icon-save'" style="width:800;height:400px;padding:5px;">
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td width="42%">
															...
															<div class="list_tit"><span id="userName" ></span>&nbsp;未分配角色列表</div>
														</td>
														<td width="15%">&nbsp;</td>
														<td width="43%">
															<div class="list_tit"><span id="userName1" ></span>&nbsp;已分配角色列表</div>
														</td> 
													</tr>
													<tr>
														<td>
															<select size="20"  id="unAssignRoleList" style="width: 100%" multiple="multiple">
															</select>
														</td>
														<td>
															<p align="center">
														...
														<td>
															<select name="destList" size="20" multiple="multiple" id="assignRoleList" style="width: 100%">
															</select>
														</td>
													</tr>
												</table>
