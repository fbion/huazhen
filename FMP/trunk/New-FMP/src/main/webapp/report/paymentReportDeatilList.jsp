...
<html>
    ...
    <div class="mt50">
        ...
        <input type="hidden" id="showCardNumberAndCellphone" value="<s:property value="showCardNumberAndCellphone"/>" />
        <div id="paymentReportDeatilContent" class="paymentdetailstable"></div>
        <table align="center" border="1"  id="aduitComment" class="aduittable">
        </table>
        <p id="btn" class="mt50 submitaudit">
        		<s:if test="showExamineSubmitButton">
