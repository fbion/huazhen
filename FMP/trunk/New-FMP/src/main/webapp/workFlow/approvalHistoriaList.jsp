...
<m:ContentPage materPageId="newLayout">
    <m:Content contentPlaceHolderId="center">
        ...
        <div>
        		<label>标题:</label>
                <select id="selectTitle" style="width:100px;" data-options="prompt:'标题',searcher:approvalHistoriaList.InitQuery">
                ...
                <label>状态:</label>
                <select id="status"  data-options="prompt:'状态',searcher:approvalHistoriaList.InitQuery">
