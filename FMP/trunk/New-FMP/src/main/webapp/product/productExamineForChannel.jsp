    ...
    <table align="center" border="1" class="tc data">
        ...
        <tr>
            ...
            <td valign="center" colspan="2" >
                <input type="text" value="" style="width:680px;" class="name disabled"/>
            </td>
        </tr>
        <tr>
            <td width="100" height="30" valign="center" >预期年化收益率%</td>
            <td valign="center" colspan="2" >
                <textarea style="width:680px;" class="expectProfit disabled"></textarea>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td valign="center" colspan="2" >渠道</td>
        </tr>
        <tr>
            <td width="100" height="30" valign="center" >承销额度</td>
            <td valign="center"  colspan="2" ><input type="text" value=""  class="task_amout1 disabled"/>元</td>
        </tr>
        <tr>
            <td width="100" height="30" valign="center" >完成策略</td>
            <td valign="center" colspan="2" >
                <textarea style="width:680px;" class="sales_policy1 disabled"></textarea>
            </td>
        </tr>
        <tr>
            <td width="100" valign="center" >服务费率</td>
            <td valign="center" colspan="2" >
                <textarea style="width:680px;" class="quota1 disabled"> </textarea>
            </td>
        </tr>
        <tr>
            <td width="100" valign="center" >激励政策</td>
            <td valign="center" colspan="2" >
                <textarea style="width:680px;" class="incentive_policy1 disabled"></textarea>
            </td>
        </tr>
        <tr>
            <td width="100" valign="center" >当前销售</td>
            <td valign="center" colspan="2" >
                <input type="text" value="" style="width:680px;" class="disabled currAmout1 "/>
            </td>
        </tr>
        </tbody>
    </table>
