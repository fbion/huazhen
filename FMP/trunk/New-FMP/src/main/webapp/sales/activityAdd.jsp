                ...
                <ul class="tab_content mt30">
                 ...
                 <form id="activityAdd" style="z-index:9999;">
                        	<table border="1" width="70%" class="activityTheme tc">
                                ...
                                <tbody>
                                	<tr>
                                        ...
                                        <div class="Validform_checktip"></div></td>
                                        <td><input id="longitude" name="longitude" type="text" disabled="disabled" class="data w70"/>
                                        <div class="Validform_checktip"></div></td>
                                        <td><input id="latitude" name="latitude" type="text" disabled="disabled" class="data w70"/>
                                        <div class="Validform_checktip"></div></td>
                                    </tr>
                                    <tr>
                                    	<td colspan='4' height="100" class="tl">扫右侧二维码即可打开活动链接 </td>
                                        <td colspan='3'><img id="qrcode"/></td>
                                    </tr>
                                    <tr>
                                    	<td height="336">活动内容</td>
                                        <td colspan='6' class="tl">
                                        <textarea cols="133" rows="20" id="content" disabled="disabled" class="data ckeditor"></textarea>
                                        <div class="Validform_checktip"></div></td>
                                    </tr>
                                    <tr>
                                    	<td height="112">备注</td>
                        ...
                        <jsp:include page="/sales/applyCustomerList.jsp"></jsp:include> 
                         ...
                         <li class="tab_content6 tabContent">
                         <div  id="apply"></div>
                         </li>
                    </ul>
