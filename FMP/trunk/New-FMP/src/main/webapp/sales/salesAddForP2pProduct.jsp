                    ...
                    <li class="tab_content1  tabContent" style="display:block;">
                        <div class="basic_Info_content p15 info_All">
                            <form id="salesAddForP2pProduct" style="z-index:9999;">
                                <ul>
                                    <li> <input id="relationSalesNo" name="relationSalesNo" type="hidden" class="ml20 data"/>
                                        <div class="Validform_checktip"></div>
                                    </li>
                                    <li>
                                        <input id="type" type="hidden" name="type" class="ml20" />
                                        <div class="Validform_checktip"></div>
                                    </li>
                                </ul>
                                <ul>
                                ...
                                <ul>
                                    <li><span>客户类型</span> <select id="customerType"
                                                                  name="customerType" class="ml20 data hide"></select></li>
                                    <li><span id="customer">客户</span>
                                        <select id="customerNo"  name="customerNo"class="ml20 data hide"></select>(只显示身份证填写完整的客户)
                                        <div class="Validform_checktip"></div>
                                    </li>
                                </ul>
                                <ul>
                                    <li><span>销售类型</span> <select id="peopleType"
                                                                  name="peopleType" class="ml20 data hide"></select></li>
                                    <li><span>渠道</span> <select id="peopleNo"
                                                                name="peopleNo" class="ml20 data"></select>
                                        <div class="Validform_checktip"></div>
                                    </li>
                                ...
                                <ul>
                                    <li><span>打款状态</span> <select id="status" name="status"
                                                                  class="ml20 data hide"></select></li>
