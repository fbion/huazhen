...
　　        该笔债权出借期限届满后本金及收益总额为:
        ...
        <div class="onreason2">2、贵方债权出借编号为：<span class="underline_bottom"><s:property value="loanNumber" /></span>;</div>
        <div class="tin30">该笔债权出借期限届满后本金及收益总额为:
                 <span class="underline_bottom">￥<s:property value="expireMoney"/></span>
                 （大写：<span class="underline_bottom">人民币<s:property value="capitalMoney"/></span>）。

        </div>
		<div class="onreason3">3、本承诺函为《个人出借咨询与服务合同》之附件，与该合同具有同等法律效力，内容若有不一致处，以本承诺函为准。</div>
		<div class="hztitle">河北燕阳建筑集团有限公司（公章）</div>
		<div class="hztitle1"><span><s:property value="today"/></span></div>
    </div>
</body>
</html>
