var ManagePage = {
   DateInputElem: function (value, options) {
    ...
    GetDetail: function (index,activitiNo) {
        $EasyUI.NewTab("Edit",$Url.BuildEmployeeUrl("/employee/extendProbationApplication/edit?id="+index+"&activitiNo="+activitiNo));
    },
    GetAdd: function () {
        $EasyUI.NewTab("New",$Url.BuildEmployeeUrl("/employee/extendProbationApplication/edit"));
    },
