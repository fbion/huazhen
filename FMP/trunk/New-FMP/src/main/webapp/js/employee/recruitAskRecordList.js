var ManagePage = {
    ...
    GetDetail: function (index) {
        $EasyUI.NewTab("Detail", $Url.BuildEmployeeUrl("/employee/recruitAskRecord/edit?id="+index));
    },
    Sms: function (index) {
        $('#w').window('open');
        $("#ok").click(function(){
...
//                    day:day
    ...
    GetAdd: function () {
        $EasyUI.NewTab("Add",$Url.BuildEmployeeUrl("/employee/recruitAskRecord/edit"));
    },
