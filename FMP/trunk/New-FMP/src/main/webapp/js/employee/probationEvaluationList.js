var ManagePage = {
    ...
    GetDetail: function (index,activitiNo) {
        $EasyUI.NewTab("Detail", $Url.BuildEmployeeUrl("/employee/probationEvaluation/edit?id="+index+"&activitiNo="+activitiNo));
    },

    GetAdd: function () {
        $EasyUI.NewTab("New", $Url.BuildEmployeeUrl("/employee/probationEvaluation/edit"));
    },
