var ManagePage = {
    ...
    GetDetail: function (index,activitiNo) {
        $EasyUI.NewTab("New",$Url.BuildEmployeeUrl("/employee/personalChange/edit?id="+index+"&activitiNo="+activitiNo));
    },

    GetAdd: function () {
        $EasyUI.NewTab("New",$Url.BuildEmployeeUrl("/employee/personalChange/edit"));
    },
