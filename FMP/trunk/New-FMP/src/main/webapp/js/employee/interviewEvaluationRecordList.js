var ManagePage = {
    ...
    GetDetail: function (index,name) {
        $EasyUI.NewTab("Edit",$Url.BuildEmployeeUrl("/employee/interviewEvaluationRecord/edit?id="+index+"&&name="+name));
    },
    GetAddReTest:function(index,name,showReTest){
        $EasyUI.NewTab("New",$Url.BuildEmployeeUrl("/employee/interviewEvaluationRecord/edit?id="+index+"&name="+name+"&showReTest="+showReTest));
    },

    GetAdd: function () {
        $EasyUI.NewTab("New",$Url.BuildEmployeeUrl("/employee/interviewEvaluationRecord/edit"));
    },
