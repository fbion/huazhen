var ManagePage = {
  DateInputElem: function (value, options) {
    ...
    GetDetail: function (index,activitiNo) {
        $EasyUI.NewTab("Edit",$Url.BuildEmployeeUrl("/employee/deptYearNeed/edit?id="+index+"&activitiNo="+activitiNo));
...
//    	var backUrl = window.location.href;
        $EasyUI.NewTab("Add",$Url.BuildEmployeeUrl("/employee/deptYearNeed/edit"));
    }
}
...
$(function () {
    ...
    EnumList.GetEnumListToSelect($("#selectDepartment"), "deptAll", $Url.BuildEmployeeUrl("/common/enumList.action"));
	 $("#btnYearNeedTotal").click(function (){
         $EasyUI.NewTab("",$Url.BuildEmployeeUrl("/employee/yearNeedTotal/list"));
     });
