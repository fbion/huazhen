var ManagePage = {
    ...
    GetInfo: function (id) {
        var url = $Url.BuildBaseInfoUrl("/baseInfo/calendar/ajaxGetCalendar");
        $.ajax({
            type: "post",
            url: url,
            dataType: "json",
...
$(function () {
    $("#back").click(function () {
        //window.location.href = $Url.BuildBaseInfoUrl("/baseInfo/calendar/list");
        $EasyUI.Close();
    });
    ...
    var calendarAdd = $("#calendarAdd").Validform({
        ...
        callback: function (form) {
            ...
            $.ajax({
                ...
                success: function (data, textStatus) {
                    if (data.errCode == "0000") {
                        window.location.href = $Url.BuildBaseInfoUrl("/baseInfo/calendar/edit?id=" + data.errDesc);
                    } else {
                        $("#msg").text(data.errDesc);
                    }
                },
