var ManagePage = {
    ...
    InitGrid: function () {
        //grid start
        $("#gridTable").jqGrid({
            url: $Url.BuildBaseInfoUrl('/baseInfo/dicType/ajaxListDicType.action'),
            editurl: $Url.BuildBaseInfoUrl("/baseInfo/dicType/ajaxEditDicType.action"),
            datatype: "json",
            mtype: 'GET',
            colNames: ["操作","id","名称","备注","状态","修改备注"],
            colModel: [
				...
				{
					name: "remarks", index: "remarks", width: 40, align: "left", formoptions: { rowpos: 2, colpos: 2 }, sortable: false, editable: true, editoptions: { size: 40 }
				},
				{
					name: "status", index: "status", width: 40, align: "left", formatter: "select", edittype: "select", editoptions: { size: 1, value: EnumList.GetEnumListToEdit("status", $Url.BuildBaseInfoUrl("/common/enumList.action"))}, formoptions: { rowpos: 3, colpos: 1 }, sortable: false, editable: true
				},
				{
    ...
    InitQuery: function () {
        $("#btnSearch").click(function () {
            ...
            $("#gridTable").jqGrid('setGridParam', {
                datatype: "json",
                postData: { "name": name,"status":status },
                page: 1
            }).trigger("reloadGrid");
        });
    },
...
$(function () {
    ...
    EnumList.GetEnumListToSelect($("#selectStatus"), "status", $Url.BuildBaseInfoUrl("/common/enumList.action"));
