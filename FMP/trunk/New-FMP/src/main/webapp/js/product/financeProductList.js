...
var P2pProductList = {
    InitGrid: function () {
        ...
        $("#gridTable").datagrid({
            ...
            columns: [[
                { field: 'id', title: '编号', align: 'center', width:'5%',halign: 'center', hidden: false, sortable: false },
                ...
                { field: 'repaymentIssue', title: '付息方式', width:'5%',align: 'center', halign: 'center', hidden: false, sortable: false ,
                ...
                { field: 'inTime', title: '录入时间', align: 'center',width:'5%', halign: 'center', hidden: false, sortable: true,
                    formatter: function (value, row, index) {
                        if(!$String.IsNullOrEmpty(value)){
                            return value.toDate().format("yyyy-MM-dd");
                        }
