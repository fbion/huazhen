var ManagePage = {
    ...
    GetAdd:function(){
        $EasyUI.NewTab("New", $Url.BuildProductUrl("/product/financierPersonal/edit"));
    },
    GetDetail:function(id){
        $EasyUI.NewTab("Detail", $Url.BuildProductUrl("/product/financierPersonal/edit?id="+id));
    },
    GetEdit:function(id){
        $EasyUI.NewTab("Edit", $Url.BuildProductUrl("/product/financierPersonal/detail?id="+id));
    },
    ShowPoint:function(){
