var ManagePage = {
    ...
    GetAdd:function(){
        $EasyUI.NewTab("New", $Url.BuildProductUrl("/product/financierBusiness/edit"));
    },
    GetEdit:function(id){
        $EasyUI.NewTab("Edit", $Url.BuildProductUrl("/product/financierBusiness/detail?id="+id));
    },
    GetDetail:function(id){
        $EasyUI.NewTab("Detail", $Url.BuildProductUrl("/product/financierBusiness/edit?id="+id));
    },
    ShowPoint:function(){
