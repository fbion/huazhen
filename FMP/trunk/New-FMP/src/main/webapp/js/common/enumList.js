...
var EnumListWithEasyUI = {
    ...
    GetEnumListToGrid: function (value, listName, listUrl, noCache) {
        if ((!EnumListWithEasyUI.SelEnumCache(listName) && noCache == undefined) || Boolean(noCache)) {
            $.ajax({
                type: "post",
                url: listUrl,
                dataType: "json",
    ...
    GetEnumListToCombo: function (listName, listUrl, param) {
        var comboValue;
        $.ajax({
            type: "post",
            url: listUrl,
