...
public class BannerLocationFacade {
	...
	public static BannerLocation getInfoByCondition(BannerLocationCondition bannerLocationCondition) {
		BannerLocationService bannerLocationService = (BannerLocationService) context.getBean("bannerLocationService");

        return bannerLocationService.getInfoByCondition(bannerLocationCondition);
	}
}
