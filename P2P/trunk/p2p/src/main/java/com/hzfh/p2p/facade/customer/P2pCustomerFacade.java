...
public class P2pCustomerFacade {
	...
	public static int updateRealNameCustomerNo(P2pCustomer p2pCustomer) {
		P2pCustomerService p2pCustomerService = (P2pCustomerService) context.getBean("p2pCustomerService");
		return p2pCustomerService.updateRealNameCustomerNo(p2pCustomer);
	}
	...
	public static P2pCustomer getInfoByQq(String openid) {
		P2pCustomerService p2pCustomerService = (P2pCustomerService) context.getBean("p2pCustomerService");
		return p2pCustomerService.getInfoByQq(openid);
	}

	public static P2pCustomer getInfoByWeibo(String weibo) {
		P2pCustomerService p2pCustomerService = (P2pCustomerService) context.getBean("p2pCustomerService");
		return p2pCustomerService.getInfoByWeibo(weibo);
	}
