...
public class RegexHelper {
    ...
    public static final String REGEX_NUMBER =PropertyHelper.getContextProperty("regex_number").toString();
    public static final String REGEX_USER_NAME =PropertyHelper.getContextProperty("regex_user_name").toString();
    public static final String REGEX_PIC =PropertyHelper.getContextProperty("regex_pic").toString();
