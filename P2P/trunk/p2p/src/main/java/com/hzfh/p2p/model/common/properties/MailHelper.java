...
public class MailHelper {
    ...
    //审核修改邮箱
    public static final String MAIL_AUDITOR = PropertyHelper.getContextProperty("mail.auditor").toString();
    public static final String MAIL_AUDIT_SUBJECT = PropertyHelper.getContextProperty("mail.audit.subject").toString();
    public static final String MAIL_AUDIT_BODY = PropertyHelper.getContextProperty("mail.audit.body").toString();
}
