...
import com.hzfh.p2p.facade.sales.P2pInvestmentFacade;
...
public class P2pInvestmentModel {
	...
	public static List<P2pInvestment> getListByP2pCustomerNo(int customerNo) {
		return P2pInvestmentFacade.getListByP2pCustomerNo(customerNo);
	}
}
