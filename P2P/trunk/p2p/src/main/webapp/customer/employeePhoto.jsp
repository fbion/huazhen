...
<!--<ul>
	<s:iterator value="#request.employeeList" id="item">
		<li>
			<img src="<s:property value="#item.portraitPath"/>" width="150" height="200" />
            <p>
            	<input type="radio" value='<s:property value="#item.userNo"/>' name="choose_customers"/>
                <label class="pl5"><s:property value="#item.name"/></label>
            </p>
	    </li>
	</s:iterator>
</ul>-->
