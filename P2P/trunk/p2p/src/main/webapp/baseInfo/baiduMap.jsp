...
<body>
  ...
  <input type="text" value="${longitude}" id="longitude"/>
  <input type="text" value="${latitude}" id="latitude"/>
...
<script type="text/javascript">
    ...
    //标注点数组
    var markerArr = [{title:title,content:"电话："+telephone+"<br/>地址："+address,point:longitude+"|"+latitude,isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
		 ];
    //创建marker
    function addMarker(){
